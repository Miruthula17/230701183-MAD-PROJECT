...
class _BoardScreenState extends State<BoardScreen> {
      ...
      appBar: AppBar(
        title: Row(
          children: [
            Container(
              ...
              child: const Icon(Icons.work_rounded, color: const Color(0xFF191919), size: 22),
            ),
        ...
        actions: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: _showSearch ? const Color(0xFF0A66C2).withValues(alpha: 0.2) : const Color(0xFFFFFFFF),
              borderRadius: BorderRadius.circular(12),
            ...
            child: IconButton(
              icon: Icon(
                ...
                size: 22,
                color: _showSearch ? const Color(0xFF70B5F9) : Colors.grey,
              ),
              tooltip: 'Search',
              onPressed: () {
                setState(() {
                ...
                ? Container(
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        prefixIcon: const Icon(Icons.search_rounded, color: Color(0xFF70B5F9)),
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(
                colors: [
                  ...
                  const Color(0xFF70B5F9).withValues(alpha: 0.08),
                ],
              ),
  ...
  PopupMenuItem<String> _buildSortItem(String value, String label, IconData icon, String current) {
    ...
    return PopupMenuItem(
      ...
      child: Row(
        children: [
          Icon(icon, size: 18, color: isSelected ? const Color(0xFF70B5F9) : Colors.grey),
          const SizedBox(width: 10),
          Text(label, style: TextStyle(color: isSelected ? const Color(0xFF70B5F9) : const Color(0xFF191919))),
          if (isSelected) ...[
            const Spacer(),
            const Icon(Icons.check_rounded, size: 18, color: Color(0xFF70B5F9)),
          ],
        ],
      ),
    );
